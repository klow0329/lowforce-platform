...
const { listCountries, listAgents, listSegments, listSalespeople, listEvents, listEventCategories, listMainEvents, listStages, getCompany, listCnReasonCodes } = require('../controllers/reference.controller');
...
router.get('/main-events', asyncHandler(listMainEvents));
